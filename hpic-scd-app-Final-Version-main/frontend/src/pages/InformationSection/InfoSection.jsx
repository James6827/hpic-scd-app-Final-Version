...
import { MdHealthAndSafety, MdLocalHospital, MdGroup, MdSchool } from "react-icons/md";
  ...
  return (
    <section className="info-section">
      ...
      <div className="info-grid">
        ...
        <Link to="/EarlyDetection" className="info-card-link">
          <div className="info-card">
          <div className="info-icon"><MdHealthAndSafety /></div>            <h3>Early Detection</h3>
